...
Trust model, in order:
  1. If the operator opts in via ``UNSLOTH_STUDIO_TRUST_FORWARDED`` (Tough Customer behind
  ...
  2. If the socket peer is loopback, honor ``CF-Connecting-IP``. Tough Customer's managed
