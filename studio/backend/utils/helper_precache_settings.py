...
def get_helper_precache_enabled() -> bool:
    ...
    Missing or unreadable settings default to False so Tough Customer startup never
...
def set_helper_precache_enabled(value: Any) -> bool:
    """Persist whether Tough Customer should pre-cache the Helper LLM at startup."""
