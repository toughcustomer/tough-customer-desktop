...
"""Network-free Tough Customer release version resolution for display-only UI."""
...
def is_valid_studio_release_version(value: object) -> bool:
    """Return True for Tough Customer release tags such as ``v0.1.39-beta``."""
...
def get_studio_version(repo_root: Path | None = None) -> str:
    """Return the installed Tough Customer release tag for display, or ``dev``.
