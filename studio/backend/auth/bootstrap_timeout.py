...
"""Auto-shutdown for an exposed first-run Tough Customer whose admin password is unchanged.
...
a deadline, tear Tough Customer down so a fresh, unconfigured instance does not stay
publicly reachable indefinitely. If the password was changed, Tough Customer keeps
running.
...
def enforce_bootstrap_password_deadline(
    ...
    *,
    ...
    Returns True if it shut Tough Customer down, False if it left it running (the
