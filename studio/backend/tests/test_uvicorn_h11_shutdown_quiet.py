...
* ``uvicorn.protocols.http.auto.AutoHTTPProtocol`` is forced to ``H11Protocol``,
  ...
  Tough Customer requirements pin plain uvicorn, which is the h11 path the report hit.
...
def patched_protocol_class(monkeypatch):
    """The protocol Tough Customer installs when uvicorn would otherwise use plain h11."""
