...
Tough Customer's log-reduction work is several PRs deep and every round of it started with someone
    ...
    def test_scenario_stays_inside_its_envelope(
        ...
        if result.emitted > envelope:
            ...
            pytest.fail(
                ...
                "decision about how much Tough Customer is allowed to write when nobody is using "
                "it."
            )
