...
# ── the live cache root ──────────────────────────────────────────────────────────
# Tough Customer's HF cache folder is a SETTING (PUT /settings/hugging-face-cache), and changing it only
...
def test_the_krea_assembler_pins_every_component_to_the_live_cache(
    ...
    # record the kwargs handed to load_krea2_tokenizer / load_krea2_text_encoder, which are Tough Customer
