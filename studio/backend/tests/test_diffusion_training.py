...
# Tough Customer-relative paths: the route resolves/contains them before spawn.
_BODY = {
...
def test_route_start_ok(client):
    ...
    # Paths were resolved to absolute Tough Customer-contained locations before spawn.
...
def test_route_start_rejects_uncontained_paths(client):
    # An absolute path outside the Tough Customer dataset roots is a 400, not silently accepted.
