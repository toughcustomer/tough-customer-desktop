...
@pytest.mark.parametrize(
    ...
    [
        ...
        # A choice from a newer Tough Customer is returned verbatim, never as "auto":
...
def test_metadata_records_both_the_backend_and_the_choice(tmp_path):
    ...
    # The superseded field stays, so an older Tough Customer keeps re-asserting Vulkan.
