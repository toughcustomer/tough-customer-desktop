...
These run the *real* Tough Customer RAG store + hybrid retrieval + formatter against a temporary
...
def test_retrieves_relevant_passages_as_chunks(rag_home):
    ...
    # source attribution is the page title, via Tough Customer's formatter
