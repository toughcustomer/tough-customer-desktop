...
_MPS_FREE_MIB = int(_MPS_TOTAL_MIB * 0.80)  # RAM free once macOS + a browser + Tough Customer are up
...
def test_unified_oversize_decision_matrix_for_the_real_video_families():
    ...
    ``free`` is modelled at 80% of RAM, the share left once macOS, a browser and Tough Customer are up.
    """
