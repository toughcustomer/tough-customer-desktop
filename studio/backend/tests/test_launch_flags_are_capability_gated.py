...
or user-supplied LLAMA_SERVER_PATH, which Tough Customer explicitly supports: an unknown
...
class TestAFlaglessBuildIgnoresTheFlashAttentionEnv:
    ...
    declares it, so a binary predating the flag registers neither. Tough Customer still
