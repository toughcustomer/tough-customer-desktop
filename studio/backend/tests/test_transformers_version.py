...
class TestDamagedLatestSidecarRepairHandoff:
    ...
    def _patch(
        ...
        # CONFIG_MAPPING_NAMES is {"brandnew": "C"} into the developer's own Tough Customer.
        #
    ...
    def test_every_sidecar_dir_is_redirected_away_from_the_real_studio_home(
        ...
        assert not stray, (
            ...
            f"provisions one of those writes test fixture data into the real Tough Customer "
