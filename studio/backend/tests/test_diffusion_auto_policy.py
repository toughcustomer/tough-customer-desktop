...
def test_klein_base_9b_is_sized_like_the_9b_not_the_4b():
    ...
    # The unsloth mirror is what Tough Customer actually loads, and canonical_base has to route it here too.
    assert (
...
def test_the_cached_probe_is_pinned_to_the_active_cache_root(monkeypatch):
    ...
    Tough Customer's cache folder is a setting, so after it changes the retry proves the checkpoint cached
