...
context than the requested -c while Tough Customer keeps advertising the requested
...
def test_kv_unified_added_for_multi_slot():
    ...
    default, splitting -c into per-slot windows of -c/N; Tough Customer must restore
