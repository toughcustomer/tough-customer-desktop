...
def _hub_cache_roots() -> list[str]:
    ...
    Tough Customer can move its cache during a session (Settings), and loading follows the live setting,
    ...
    constant stays as a fallback, since the trainer subprocess may run without Tough Customer's settings
    module importable."""
