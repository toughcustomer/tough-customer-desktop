...
# hiccup into "no xFormers for the rest of this Tough Customer session".
...
def _ensure_attention_backend_installed(backend: str, logger: Any = None) -> Optional[str]:
    ...
    try:
        if importlib.util.find_spec(module) is not None:
            ...
            # passes --reinstall-package, outside any request. What this branch prevents is Tough Customer CREATING the
