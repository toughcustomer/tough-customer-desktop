...
# Opt-in startup kill switch for Tough Customer's in-memory API monitor.
...
class ApiMonitorEntry:
    ...
    # True for sk-unsloth callers only: the panel auto-opens on these, not Tough Customer's chat.
