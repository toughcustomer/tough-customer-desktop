...
bypass Tough Customer's tool loop and are relayed to/from llama-server verbatim. Small
...
output. Responses without a tool signal, requests without tools, and Tough Customer's
