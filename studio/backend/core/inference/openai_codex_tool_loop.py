...
"""Tough Customer-owned tool execution loop for the ChatGPT Codex subscription transport.
...
def stream_codex_with_studio_tools(
    ...
    *,
    ...
    """Stream Codex, execute requested Tough Customer tools, and continue until a final answer."""
