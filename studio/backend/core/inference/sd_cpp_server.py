...
asset resolution, request validation, and the public Tough Customer surface.
...
class SdCppServer:
    ...
    def _port_is_ours(self) -> bool:
        ...
        OpenAI-compatible route that llama.cpp's own server (and a second Tough Customer) answers 200 on,
