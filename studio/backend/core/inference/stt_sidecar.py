...
Whisper repo; weights come through Tough Customer's Model Hub and stay warm briefly
...
def resolve_model_id(model: Optional[str]) -> str:
    ...
    raise SttModelIdError(
        "STT model must be one of Tough Customer's defaults or a Hugging Face "
...
def _active_hf_hub_cache() -> Path:
    ...
    try:
        ...
        # Tough Customer's live cache setting takes precedence over environment defaults.
