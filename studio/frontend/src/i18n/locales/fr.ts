...
export const fr = {
  ...
  settings: {
    ...
    dialog: {
      title: "Paramètres",
      description: "Gérez vos préférences Tough Customer.",
    ...
    keyboardShortcuts: {
      ...
      actions: {
        ...
        logOut: {
          ...
          description: "Se déconnecter d’Tough Customer",
        },
        approveToolRequest: {
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Chargé",
        sttUnavailable:
          "Non installé sur ce serveur. Exécutez the Update action in Settings pour activer la dictée locale.",
        sttRetry: "Réessayer",
        ...
        micAccessBlocked:
          "L'accès au microphone a été bloqué. Autorisez l'accès au microphone pour cette page Tough Customer, puis réessayez.",
    ...
    general: {
      title: "Général",
      description: "Préférences globales pour Tough Customer.",
      account: "Compte",
      ...
      passwordDescription:
        "Changez le mot de passe de ce compte Tough Customer.",
      passwordDialog: {
        ...
        setDescription:
          "Choisissez le mot de passe utilisé par les navigateurs distants pour se connecter avec l'identifiant unsloth (au moins {minLength} caractères). L'application de bureau Tough Customer continue de se connecter automatiquement.",
      ...
      modelAutoSwitch: {
        ...
        apiOnlyDescription:
          "Le déchargement en cas d'inactivité laisse en mémoire un modèle que vous avez chargé depuis Tough Customer et ne libère que ceux chargés par une requête API.",
      },
      previewSharing: {
      ...
      startup: {
        ...
        launchAtLogin: "Lancer Tough Customer à la connexion",
        launchAtLoginDescription:
          "Démarre Tough Customer en arrière-plan lorsque vous vous connectez. Il reste dans la barre de menus ou la zone de notification jusqu'à ce que vous l'ouvriez.",

        closeToTray: "Fermer dans la zone de notification",
        closeToTrayDescription:
          "Laisser Tough Customer et son serveur fonctionner en arrière-plan lorsque vous fermez la fenêtre principale.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Efface les préférences locales uniquement et recharge Tough Customer. Les discussions, l'accès API et les paramètres stockés en base de données sont conservés.",
      ...
      permissions: {
        ...
        bypassDescription:
          "Comment Tough Customer approuve les appels d'outils de la discussion (terminal, python, web, MCP) avant leur exécution. Le mode « Full access » désactive les demandes d'approbation et le bac à sable d'exécution du code.",
      },
    },
    profile: {
      title: "Profil",
      description: "Comment votre profil apparaît dans Tough Customer.",
      changePicture: "Changer la photo de profil",
      displayName: "Nom affiché",
      nickname: "Comment Tough Customer doit-il vous appeler ?",
      ...
      stats: {
        ...
        subtitle:
          "Tout ce qui suit est calculé à partir de votre propre historique. Rien n'est collecté ni envoyé à Tough Customer.",
        retry: "Réessayer",
        privacyNote:
          "Les statistiques sont calculées à partir de l'historique local des discussions, de l'utilisation de l'API et des entraînements de votre installation Tough Customer. Les requêtes, réponses et clés API ne sont jamais stockées pour les statistiques. Rien n'est envoyé à Tough Customer ni à un tiers.",
        emptyChats:
        ...
        studioChatTokens: "Tokens de Tough Customer Chat",
    ...
    appearance: {
      title: "Apparence",
      description: "L'apparence d'Tough Customer sur cet appareil.",
      theme: {
        title: "Thème",
      ...
      palette: {
        label: "Palette",
        description: "Couleurs utilisées dans Tough Customer, en mode clair et sombre.",
        standard: "Standard",
        classic: "Classique",
        minimal: "Minimale",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description: "Ajustez la taille de base utilisée pour l'interface Tough Customer.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "La langue utilisée par Tough Customer.",
    ...
    resources: {
      title: "Système",
      description:
        "Surveillez le matériel et le stockage de ce serveur Tough Customer.",
      ...
      llamaBackend: {
        ...
        customPath: {
          ...
          bundled: "Utilise le runtime llama.cpp installé par Tough Customer.",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp est un dossier local que vous avez lié vous-même ; Tough Customer ne le remplacera pas.",
    ...
    agents: {
      ...
      intro:
        "connecte Claude Code, Codex, DeepSeek Harness, Hermes, OpenClaw, OpenCode et d'autres agents à un modèle servi localement par Tough Customer, entièrement hors ligne. Il lance un serveur compatible OpenAI et ne touche jamais aux fichiers de configuration de votre agent.",
      ...
      modelNote:
        "Codex nécessite un modèle GGUF servi par llama-server. Les autres agents peuvent aussi utiliser des modèles basés sur transformers ; retirez --model pour utiliser le modèle déjà chargé dans Tough Customer.",
      subagent: {
        title: "Utiliser un modèle local comme sous-agent",
        description:
          "Gardez {agent} sur son modèle actuel et déléguez certaines tâches à ce modèle Tough Customer local.",
        ...
        opencodePrompt: "@toughcustomer trouve la cause de cet échec de test",
      },
      quickstart: {
        title: "Construire une commande",
        description:
          "Lancez un agent sur le modèle actuellement chargé dans Tough Customer. Chargez d'abord un modèle, puis remplacez claude par n'importe quel agent pris en charge ci-dessous.",
        noneDetected:
      ...
      options: {
        ...
        description:
          "Les options Tough Customer sont analysées en premier ; tout ce qu'Tough Customer ne reconnaît pas est transmis tel quel à l'agent.",
        model:
          "Sélectionne un modèle. Sans --model, unsloth start utilise le modèle actuellement chargé dans Tough Customer et échoue si aucun modèle n'est chargé.",
        contextLength:
        ...
        persist:
          "Conserve d'une exécution à l'autre les données d'agent gérées par Tough Customer.",
        asSubagent:
          "Garde l'agent parent sur son modèle actuel et enregistre Tough Customer comme sous-agent local (Claude Code, Codex et OpenCode).",
        apiKey:
          "Fournit votre clé API Tough Customer, ou lit la variable UNSLOTH_API_KEY.",
        reasoning:
      ...
      remote: {
        title: "Se connecter à un Tough Customer Studio distant",
        description:
          "Faites pointer unsloth start vers un Tough Customer Studio exécuté ailleurs en définissant ces variables avant le lancement (ou passez --api-key directement) :",
      },
      passthrough: {
        title: "Transmettre des arguments à l'agent",
        description:
          "Les arguments placés après les options Tough Customer sont transmis à l'agent lui-même, donc les commandes natives comme resume fonctionnent toujours :",
      },
      dryRun: {
    ...
    chat: {
      ...
      webSearch: {
        ...
        imagesDescription:
          "Permet à la recherche web de renvoyer des images et en récupère une pour chaque élément listé dans une réponse. Tough Customer télécharge et redimensionne les vignettes : le navigateur ne contacte jamais les hébergeurs d'images.",
      },
      artifacts: {
        title: "Canvas",
    ...
    remoteLan: {
      ...
      description:
        "Accédez à cet Tough Customer depuis vos autres appareils, via votre réseau local ou une URL publique temporaire.",
    },
    apiKeys: {
      title: "API",
      description: "Accédez à Tough Customer via l'API compatible OpenAI.",
      ...
      secureHttpsHint:
        "Le service lié à l’adresse 0.0.0.0 reste accessible sur toutes les interfaces réseau. Pour une sécurité complète, lancez Tough Customer avec --secure afin de n’exposer que ce lien HTTPS.",
    ...
    about: {
      ...
      studioVersion: "Version d'Tough Customer",
      ...
      shutDownStudio: "Arrêter Tough Customer",
      shutDownStudioDescription:
        "Arrête le serveur Tough Customer et met fin à votre session.",
      shutDown: "Arrêter",
      update: {
        title: "Mettre à jour Tough Customer",
        commandText: "Texte de la {label}",
        copied: "Copié",
        copyCommand: "Copier la commande",
        commandCopied: "{label} copiée",
        copyNamedCommand: "Copier la {label}",
        checkingInstall: "Vérification du mode d'installation d'Tough Customer...",
        installIntro: "Pour installer ou mettre à jour Tough Customer :",
        ...
        restartAfterUpdate: "Redémarrez Tough Customer après la mise à jour.",
        desktopManaged:
        ...
        desktopExternalServer:
          "Exécutez the Update action in Settings dans le terminal depuis lequel vous avez lancé le serveur.",
        ...
        desktopCurrentDescription:
          "Tough Customer continuera à rechercher automatiquement les mises à jour.",
        ...
        unknownInstall:
          "Impossible de détecter le mode d'installation d'Tough Customer. Pour les installations via installateur ou PyPI, utilisez les commandes ci-dessus.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "Tough Customer n'a pas pu confirmer le démarrage de l'entraînement. Vérification de l'état en arrière-plan.",
