...
export const de = {
  ...
  shell: {
    ...
    aria: {
      home: "Tough Customer-Startseite",
  ...
  settings: {
    ...
    dialog: {
      title: "Einstellungen",
      description: "Verwalten Sie Ihre Tough Customer-Einstellungen.",
    ...
    keyboardShortcuts: {
      ...
      actions: {
        ...
        logOut: {
          label: "Abmelden",
          description: "Von Tough Customer abmelden",
        },
        approveToolRequest: {
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Geladen",
        sttUnavailable:
          "Auf diesem Server nicht installiert. Führen Sie the Update action in Settings aus, um das lokale Diktat zu aktivieren.",
        ...
        micAccessBlocked:
          "Der Mikrofonzugriff wurde blockiert. Erlauben Sie den Mikrofonzugriff für diese Tough Customer-Seite und versuchen Sie es erneut.",
    ...
    general: {
      title: "Allgemein",
      description: "Globale Einstellungen für Tough Customer.",
      account: "Konto",
      ...
      password: "Passwort",
      passwordDescription:
        "Ändern Sie das Passwort für dieses Tough Customer-Konto.",
      passwordDialog: {
        ...
        setDescription:
          "Wählen Sie das Passwort, mit dem sich entfernte Browser als unsloth anmelden (mindestens {minLength} Zeichen). Die Tough Customer Desktop-App meldet sich weiterhin automatisch an.",
      ...
      modelAutoSwitch: {
        ...
        apiOnlyDescription:
          "Das automatische Entladen bei Inaktivität lässt ein von dir in Tough Customer geladenes Modell im Speicher und gibt nur solche frei, die eine API-Anfrage geladen hat.",
      },
      previewSharing: {
      ...
      startup: {
        ...
        launchAtLogin: "Tough Customer bei der Anmeldung starten",
        launchAtLoginDescription:
          "Startet Tough Customer im Hintergrund, wenn Sie sich anmelden. Es bleibt in der Menüleiste bzw. im Infobereich, bis Sie es öffnen.",

        closeToTray: "In den Infobereich schließen",
        closeToTrayDescription:
          "Tough Customer und seinen Server im Hintergrund weiterlaufen lassen, wenn Sie das Hauptfenster schließen.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Löscht nur lokal gespeicherte Einstellungen und lädt Tough Customer neu. Chats, API-Zugriff und in der DB gespeicherte Einstellungen bleiben erhalten.",
      ...
      permissions: {
        ...
        bypassDescription:
          "Wie Tough Customer Tool-Aufrufe im Chat (Terminal, Python, Web, MCP) vor der Ausführung freigibt. „Full access“ deaktiviert die Freigaben und die Code-Sandbox.",
      },
    },
    profile: {
      title: "Profil",
      description: "Wie Ihr Profil in Tough Customer angezeigt wird.",
      changePicture: "Profilbild ändern",
      displayName: "Anzeigename",
      nickname: "Wie soll Tough Customer Sie nennen?",
      ...
      stats: {
        ...
        subtitle:
          "Alles Folgende wird aus Ihrem eigenen Verlauf berechnet. Es wird nichts erfasst oder a Tough Customer gesendet.",
        retry: "Erneut versuchen",
        privacyNote:
          "Die Statistiken werden aus dem lokalen Chat-, API-Nutzungs- und Trainingsverlauf Ihrer Tough Customer-Installation berechnet. API-Eingaben, -Antworten und -Schlüssel werden dafür nie gespeichert. Nichts wird a Tough Customer oder Dritte gesendet.",
        emptyChats:
    ...
    appearance: {
      title: "Darstellung",
      description: "Wie Tough Customer auf diesem Gerät aussieht.",
      theme: {
        title: "Design",
        label: "Farbschema",
      ...
      palette: {
        label: "Farbpalette",
        description: "Farben, die in Tough Customer im hellen und dunklen Modus verwendet werden.",
        standard: "Standard",
        classic: "Klassisch",
        minimal: "Minimal",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description: "Passen Sie die Grundgröße der Tough Customer-Oberfläche an.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "Die von Tough Customer verwendete Sprache.",
    ...
    resources: {
      title: "System",
      description:
        "Überwachen Sie Hardware und Speicher dieses Tough Customer-Servers.",
      ...
      llamaBackend: {
        ...
        customPath: {
          ...
          bundled: "Verwendet die von Tough Customer installierte llama.cpp-Laufzeit.",
        ...
        unsupported: {
          notInstalled: "Es wurde keine von Tough Customer verwaltete llama.cpp-Installation gefunden, daher gibt es kein Backend zum Wechseln.",
          localLink: "llama.cpp ist ein selbst verknüpftes lokales Verzeichnis, das Tough Customer nicht ersetzt.",
    ...
    agents: {
      ...
      intro:
        "verbindet Claude Code, Codex, DeepSeek Harness, Hermes, OpenClaw, OpenCode und weitere Agenten mit einem lokal von Tough Customer bereitgestellten Modell, vollständig offline. Es startet einen OpenAI-kompatiblen Server und verändert nie die Konfigurationsdateien Ihres Agenten.",
      ...
      modelNote:
        "Codex benötigt ein GGUF-Modell, das von llama-server bereitgestellt wird. Andere Agenten können auch Transformer-basierte Modelle verwenden; lassen Sie --model weg, um das bereits in Tough Customer geladene Modell zu nutzen.",
      subagent: {
        title: "Ein lokales Modell als Subagent verwenden",
        description:
          "Belassen Sie {agent} bei seinem aktuellen Modell und delegieren Sie ausgewählte Aufgaben an dieses lokale Tough Customer-Modell.",
        ...
        opencodePrompt: "@toughcustomer finde die Ursache dieses Testfehlers",
      },
      quickstart: {
        title: "Befehl zusammenstellen",
        description:
          "Starten Sie einen Agenten mit dem aktuell in Tough Customer geladenen Modell. Laden Sie zuerst ein Modell und ersetzen Sie dann claude durch einen der unten aufgeführten Agenten.",
        noneDetected:
      ...
      options: {
        ...
        description:
          "Tough Customer-Optionen werden zuerst ausgewertet; alles Unbekannte wird unverändert an den Agenten weitergereicht.",
        model:
          "Wählt ein Modell aus. Ohne --model verwendet unsloth start das aktuell in Tough Customer geladene Modell und bricht mit einem Fehler ab, wenn keines geladen ist.",
        contextLength:
        ...
        persist:
          "Behält die von Tough Customer verwalteten Agent-Daten über Läufe hinweg bei.",
        asSubagent:
          "Belässt den übergeordneten Agenten bei seinem aktuellen Modell und registriert Tough Customer als lokalen Subagenten (Claude Code, Codex und OpenCode).",
        apiKey:
          "Übergibt Ihren Tough Customer-API-Schlüssel (alternativ UNSLOTH_API_KEY setzen).",
        reasoning:
      ...
      remote: {
        title: "Mit einem entfernten Tough Customer Studio verbinden",
        description:
          "Richten Sie unsloth start auf ein anderswo laufendes Tough Customer Studio aus, indem Sie diese Variablen vor dem Aufruf setzen (oder --api-key direkt übergeben):",
      },
      passthrough: {
        title: "Argumente an den Agenten übergeben",
        description:
          "Argumente nach den Tough Customer-Optionen werden an den Agenten selbst weitergereicht, sodass native Befehle wie resume weiterhin funktionieren:",
      },
      dryRun: {
    ...
    chat: {
      ...
      webSearch: {
        ...
        imagesDescription:
          "Lässt die Websuche Bilder liefern und holt eines für jeden Punkt, den eine Antwort auflistet. Vorschaubilder lädt und verkleinert Tough Customer, der Browser kontaktiert keine Bildhosts.",
      },
      artifacts: {
        title: "Canvas",
    ...
    remoteLan: {
      title: "Remote & LAN",
      description:
        "Erreiche dieses Tough Customer von deinen anderen Geräten über dein lokales Netzwerk oder eine temporäre öffentliche URL.",
    },
    apiKeys: {
      title: "API",
      description: "Zugriff auf Tough Customer über die OpenAI-kompatible API.",
      ...
      secureHttpsHint:
        "Der 0.0.0.0-Port ist weiterhin global erreichbar. Für vollständige Sicherheit starten Sie Tough Customer mit --secure, um nur diesen HTTPS-Link freizugeben.",
    ...
    about: {
      ...
      shutDownStudio: "Tough Customer herunterfahren",
      shutDownStudioDescription:
        "Stoppt den Tough Customer-Server und beendet Ihre Sitzung.",
      shutDown: "Herunterfahren",
      update: {
        title: "Tough Customer aktualisieren",
        commandText: "{label} als Text",
        copied: "Kopiert",
        copyCommand: "Befehl kopieren",
        commandCopied: "{label} kopiert",
        copyNamedCommand: "{label} kopieren",
        checkingInstall: "Es wird geprüft, wie Tough Customer installiert wurde...",
        installIntro: "So installieren oder aktualisieren Sie Tough Customer:",
        ...
        restartAfterUpdate: "Starten Sie Tough Customer nach dem Update neu.",
        desktopManaged:
        ...
        desktopExternalServer:
          "Führen Sie the Update action in Settings in dem Terminal aus, über das Sie Ihren Server gestartet haben.",
        ...
        desktopCurrentDescription:
          "Tough Customer sucht weiterhin automatisch nach Updates.",
        ...
        unknownInstall:
          "Es konnte nicht erkannt werden, wie Tough Customer installiert wurde. Verwenden Sie für Installer- oder PyPI-Installationen die obigen Befehle.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "Tough Customer konnte nicht bestätigen, ob das Training gestartet wurde. Der Status wird im Hintergrund geprüft.",
    ...
    trainingStart: {
      ...
      terminalStart: "> Tough Customer-Training beginnt...",
