...
export const it = {
  ...
  settings: {
    ...
    dialog: {
      title: "Impostazioni",
      description: "Gestisci le tue preferenze di Tough Customer.",
    ...
    keyboardShortcuts: {
      ...
      actions: {
        ...
        logOut: {
          label: "Esci",
          description: "Esci da Tough Customer",
        },
        approveToolRequest: {
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Caricato",
        sttUnavailable:
          "Non installato su questo server. Esegui the Update action in Settings per abilitare la dettatura locale.",
        sttRetry: "Riprova",
        ...
        micAccessBlocked:
          "L'accesso al microfono è stato bloccato. Consenti l'accesso al microfono per questa pagina di Tough Customer, poi riprova.",
    ...
    general: {
      title: "Generali",
      description: "Preferenze globali di Tough Customer.",
      account: "Account",
      ...
      password: "Password",
      passwordDescription: "Cambia la password di questo account Tough Customer.",
      passwordDialog: {
        ...
        setDescription:
          "Scegli la password con cui i browser remoti accedono come unsloth (almeno {minLength} caratteri). L'app desktop di Tough Customer continua ad accedere automaticamente.",
      ...
      modelAutoSwitch: {
        ...
        apiOnlyDescription:
          "Lo scaricamento per inattività lascia in memoria un modello caricato da te in Tough Customer e libera solo quelli caricati da una richiesta API.",
      },
      previewSharing: {
      ...
      permissions: {
        ...
        bypassDescription:
          "Come Tough Customer approva le chiamate agli strumenti della chat (terminale, python, web, MCP) prima che vengano eseguite. La modalità «Full access» disattiva le approvazioni e la sandbox del codice.",
      },
      notifications: {
        sectionTitle: "Notifiche",
        showLlamaUpdates: "Notifiche di aggiornamento di llama.cpp",
        showLlamaUpdatesDescription:
          "Avvisa quando è disponibile una build più recente di llama.cpp per eseguire nuovi modelli. Disattiva le notifiche se usi Tough Customer solo per l'addestramento.",
      ...
      startup: {
        sectionTitle: "Avvio",
        launchAtLogin: "Avvia Tough Customer all'accesso",
        launchAtLoginDescription:
          "Avvia Tough Customer in background quando accedi. Rimane nella barra dei menu o nell'area di notifica finché non lo apri.",

        closeToTray: "Chiudi nell'area di notifica",
        closeToTrayDescription:
          "Mantieni Tough Customer e il suo server in esecuzione in background quando chiudi la finestra principale.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Cancella solo le preferenze locali e ricarica Tough Customer. Le chat, l'accesso API e le impostazioni salvate nel database restano invariati.",
        confirmAction: "Reimposta e ricarica",
      },
    },
    profile: {
      title: "Profilo",
      description: "Come appare il tuo profilo in Tough Customer.",
      ...
      nickname: "Come deve chiamarti Tough Customer?",
      ...
      stats: {
        ...
        subtitle:
          "Tutto quello che vedi qui è calcolato dalla tua cronologia. Nessun dato viene raccolto o inviato a Tough Customer.",
        retry: "Riprova",
        privacyNote:
          "Le statistiche sono calcolate dalla cronologia locale di chat, utilizzo API e addestramenti della tua installazione di Tough Customer. Prompt, risposte e chiavi API non vengono mai salvati per le statistiche. Nulla viene inviato a Tough Customer o a terze parti.",
        emptyChats:
        ...
        studioChatTokens: "Token di Tough Customer Chat",
        apiTokens: "Token API",
    ...
    appearance: {
      title: "Aspetto",
      description: "Come si presenta Tough Customer su questo dispositivo.",
      theme: {
        title: "Tema",
      ...
      palette: {
        ...
        description: "Colori usati in Tough Customer, nei temi chiaro e scuro.",
        standard: "Standard",
        classic: "Classica",
        minimal: "Minimale",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description:
            "Regola la dimensione di base usata nell'interfaccia di Tough Customer.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "La lingua usata da Tough Customer.",
    ...
    resources: {
      title: "Sistema",
      description:
        "Monitora hardware e archiviazione di questo server Tough Customer.",
      ...
      llamaBackend: {
        ...
        customPath: {
          ...
          bundled: "Usa il runtime llama.cpp installato da Tough Customer.",
        ...
        unsupported: {
          notInstalled: "Nessuna installazione di llama.cpp gestita da Tough Customer, quindi non c'è un backend da cambiare.",
          localLink: "llama.cpp è una cartella locale collegata da te, quindi Tough Customer non la sostituirà.",
    ...
    agents: {
      ...
      intro:
        "collega Claude Code, Codex, DeepSeek Harness, Hermes, OpenClaw, OpenCode e altri agenti a un modello servito localmente da Tough Customer, completamente offline. Avvia un server compatibile con le API OpenAI e non modifica i file di configurazione del tuo agente.",
      ...
      modelNote:
        "Codex richiede un modello GGUF servito da llama-server. Gli altri agenti possono usare anche modelli basati su transformer; rimuovi --model per usare il modello già caricato in Tough Customer.",
      subagent: {
        title: "Usa un modello locale come subagente",
        description:
          "Mantieni {agent} sul suo modello attuale e delega alcune attività a questo modello Tough Customer locale.",
        ...
        opencodePrompt: "@toughcustomer trova la causa di questo test che non passa",
      },
      quickstart: {
        title: "Costruisci un comando",
        description:
          "Avvia un agente sul modello attualmente caricato in Tough Customer. Carica prima un modello, poi sostituisci claude con uno degli agenti supportati qui sotto.",
      ...
      options: {
        ...
        description:
          "I flag di Tough Customer vengono interpretati per primi; tutto ciò che Tough Customer non riconosce viene passato direttamente all'agente.",
        model:
          "Seleziona un modello. Senza --model, unsloth start usa il modello attualmente caricato in Tough Customer e restituisce un errore se non ce n'è nessuno.",
        contextLength:
        ...
        persist:
          "Mantieni tra un'esecuzione e l'altra i dati dell'agente gestiti da Tough Customer.",
        asSubagent:
          "Mantieni l'agente principale sul suo modello attuale e registra Tough Customer come subagente locale (Claude Code, Codex e OpenCode).",
        apiKey:
          "Fornisci la tua chiave API Tough Customer (oppure imposta UNSLOTH_API_KEY).",
        reasoning:
      ...
      remote: {
        title: "Connettersi a un Tough Customer Studio remoto",
        description:
          "Punta unsloth start a un Tough Customer Studio in esecuzione altrove impostando queste variabili prima dell'avvio (oppure passa direttamente --api-key):",
      },
      passthrough: {
        title: "Passare argomenti all'agente",
        description:
          "Gli argomenti che seguono i flag di Tough Customer vengono inoltrati all'agente, così i comandi nativi come resume continuano a funzionare:",
      },
      dryRun: {
    ...
    chat: {
      ...
      webSearch: {
        ...
        imagesDescription:
          "Consente alla ricerca web di restituire immagini e ne recupera una per ogni elemento elencato in una risposta. Le miniature vengono scaricate e ridimensionate da Tough Customer, quindi il browser non contatta mai gli host delle immagini.",
      },
      artifacts: {
        title: "Canvas",
    ...
    remoteLan: {
      title: "Remoto e LAN",
      description:
        "Raggiungi questo Tough Customer dagli altri tuoi dispositivi, tramite la rete locale o un URL pubblico temporaneo.",
    },
    apiKeys: {
      title: "API",
      description: "Accedi a Tough Customer tramite le API compatibili con OpenAI.",
      ...
      secureHttpsHint:
        "La porta su 0.0.0.0 resta raggiungibile da ovunque. Per la massima sicurezza avvia Tough Customer con --secure, così viene esposto solo questo link HTTPS.",
    ...
    about: {
      ...
      studioVersion: "Versione di Tough Customer",
      ...
      shutDownStudio: "Arresta Tough Customer",
      shutDownStudioDescription:
        "Ferma il server Tough Customer e termina la tua sessione.",
      shutDown: "Arresta",
      update: {
        title: "Aggiorna Tough Customer",
        ...
        checkingInstall:
          "Verifica della modalità di installazione di Tough Customer...",
        installIntro: "Per installare o aggiornare Tough Customer:",
        ...
        restartAfterUpdate: "Riavvia Tough Customer dopo l'aggiornamento.",
        desktopManaged:
        ...
        desktopExternalServer:
          "Esegui the Update action in Settings nel terminale da cui hai avviato il server.",
        ...
        desktopCurrentDescription:
          "Tough Customer continuerà a verificare automaticamente la disponibilità di aggiornamenti.",
        ...
        unknownInstall:
          "Impossibile rilevare come è stato installato Tough Customer. Per installazioni tramite installer o PyPI, usa i comandi sopra.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "Tough Customer non ha potuto confermare l'avvio dell'addestramento. La verifica dello stato continua in background.",
    ...
    trainingStart: {
      ...
      terminalStart: "> avvio dell'addestramento con Tough Customer...",
