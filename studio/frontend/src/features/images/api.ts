...
export interface DiffusionTrainingStatus {
  ...
  // Where the trained adapter was mirrored into the Tough Customer LoRA catalog, and the family / base it trained from.
...
// One dataset folder under the Tough Customer datasets root (GET /api/train/diffusion/info): images,
...
// Where diffusion training reads/writes on this Tough Customer, plus usable dataset folders.
...
/** Materialize a curated example dataset (by id) into a Tough Customer dataset folder. */
