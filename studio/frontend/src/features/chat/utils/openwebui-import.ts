...
/**
 * Converts Open WebUI exports to Tough Customer conversations. `history.messages` is
 ...
 * blocks are converted to Tough Customer message parts.
 */
...
export function openWebUIRecordToConversation(
  ...
  // Tough Customer sorts stored messages by createdAt, so the timeline has to be
