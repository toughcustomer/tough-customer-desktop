...
function ThreadNewChatSwitch({
  ...
  useEffect(() => {
    ...
    // the optional chain would not catch it and the effect would take the app down. Tough Customer
...
function NonceThreadResumeRestore({
  ...
  useEffect(() => {
    ...
    // ...and neither must a chat the user deleted while they were away. Tough Customer deletes by
