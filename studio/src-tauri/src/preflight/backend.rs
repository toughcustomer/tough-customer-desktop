...
pub(super) async fn backend_desktop_auth_status(
    ...
    match root_status {
        BackendRootStatus::AmbiguousRoot | BackendRootStatus::ExpectedUnavailable => {
            ...
            // id-less backend is just as likely a remote Tough Customer reached through
...
mod tests {
    ...
    /// A tunnelled or id-less Tough Customer anywhere in 8888..=8908 used to poison the
